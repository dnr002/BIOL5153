...
##Citation: Wenjie Deng, Sequence Manipulator. 
# https://indra.mullins.microbiol.washington.edu/perlscript/docs/Sequence.html 
# Taken from Google, as suggested in previous lectures.
